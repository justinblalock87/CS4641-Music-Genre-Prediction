...
# Normalize Data
normalizeColumns = ['loudness', 'tempo', 'duration_ms']
...
regularColumns = ['danceability', 'energy', 'loudness', 'mode', 'speechiness', 'acousticness', 'instrumentalness', 'liveness', 'valence', 'tempo', 'duration_ms']
...
model.add(Dense(90, input_dim = inputDim, activation = 'relu')) # Rectified Linear Unit Activation Function
